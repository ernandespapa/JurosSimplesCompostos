 ...
 * @author ernandes
 */
@WebServlet(name = "CompostosServlet", urlPatterns = {"/juros-compostos.html"})
public class CompostosServlet extends HttpServlet {
...
out.println("<form action= 'composto.html'>");
            out.println(" Montante: <input type='text' name='m'>");
            out.println(" Capital: <input type='text' name='c'>");
