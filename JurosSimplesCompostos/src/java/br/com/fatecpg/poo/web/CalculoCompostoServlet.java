 ...
 * @author T-Gamer
 */
@WebServlet(name = "CalculoCompostoServlet", urlPatterns = {"/composto.html"})
public class CalculoCompostoServlet extends HttpServlet {
  ...
  out.println("<div class='container'>");
    ...
    out.println("<div class='card text-white bg-secondary my-5 py-4 text-center'>");
      out.println("<div class='card-body'>");
        out.println("<p style='font-size:30pt;' class='text-white m-0'>  Juros Compostos </p>");
      out.println("</div>");
    out.println("</div>");
...
out.println("<form action= 'composto.html'>");
            out.println(" Montante: <input type='text' name='m'>"); // montante
            out.println(" Capital: <input type='text' name='c'>"); // capital
            out.println("<input type='submit' value='Calcular'>");
            out.println("</form>");
            
            double m = Double.parseDouble(request.getParameter("m"));//montante
            double c = Double.parseDouble(request.getParameter("c"));//capital
            
            double j = m-c; // calculo juros composto
            
            out.print("<h3>O valor de juros será de R$ " + j + "</h3>"); // resultado
